...
$html .= '<div class="field" style="top:150px;left:170px;">' . $type_vt . '</div>';
$html .= '<div class="field" style="top:205px;left:180px;">' . $name_vt . '</div>';
$html .= '<div class="field" style="top:121px;left:450px;">' .
    $currentDay . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' .
    $currentThaiMonth  . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' .
    $currentYear . '</div>';
$html .= '<div class="field" style="top:322px;left:170px;">' .
    $currentDays . '&nbsp;&nbsp;' .
    $currentThaiMonths  . '&nbsp;&nbsp;' .
    $currentYears . '</div>';
$html .= '<div class="field" style="top:322px;left:420px;">' .
    $currentDaye . '&nbsp;&nbsp;' .
    $currentThaiMonthe  . '&nbsp;&nbsp;' .
    $currentYeare . '</div>';
$html .= '<div class="field days-field" style="top:322px;left:632px;">' . $daysDiff . '</div>';
$html .= '<div class="field" style="top:205px;left:372px;">' . $position . '</div>';
$html .= '<div class="field" style="top:205px;left:600px;">' . $affiliation . '</div>';
$html .= '<div class="field" style="top:407px;left:260px;">' . $contact . '</div>';
$html .= '<div class="field" style="top:432px;left:230px;">' . $assigned . '</div>';
$html .= '<div class="field" style="top:490px;left:150px;">' . $name_vt . '</div>';
$html .= '<div class="field" style="top:548px;left:150px;">' . $assigned . '</div>';
$html .= '<div class="field" style="top:558px;left:535px;">' . $name_vt . '</div>';
$html .= '<div class="field" style="top:595px;left:535px;">' . $name_vt . '</div>';

// ตั้งค่า template
$mpdf->SetDocTemplate('form2.pdf', true);
$mpdf->WriteHTML($html);
$mpdf->Output();
